...
document.addEventListener("load", delay(receberMsg, 6000));
document.addEventListener("load", delay(exibirDivEscolhas, 9500));
...
//         case 12: //ABRIR A CAIXA DE MANHÃ (FIM DE JOGO)
//             fimDeJogo();
//             novaLegenda('[A Caixa está vazia e você se sente muito desconfortável após saber disso]Como isso tava tão pesado?');
//             break;
...
//         case 11: //CONTINUAÇÃO DA ABERTURA
//             imagemOpac(1);
//             musica.play();
//             musica.volume = 0.12;
//             novaLegenda('[Você tenta abrir a caixa mas a sua mão queima ao tocar] M@RDA, A CAIXA TA SANGRANDO?!');
...
//             divAlt.style.opacity = 0;
//             divEscolhas.innerHTML = '<button onclick="escolher(10);">Abrir</button>' +
//             '<button onclick="escolher(13)">Não Abrir</button>';
//             break;
...
//         case 16: //IR DORMIR OU SE MOVER SEM A CAIXA
...
//         case 17: //LIGANDO 190 SEM A CAIXA
...
//         case 22: //FICAR IMÓVEL A NOITE TODA(FIM DE JOGO)
